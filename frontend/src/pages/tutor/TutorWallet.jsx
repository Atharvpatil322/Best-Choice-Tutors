/**
 * Tutor Wallet Page
 * Read-only wallet: total, pending, available earnings and list of ledger entries.
 * No withdrawals. shadcn/ui only.
 */
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              Ledger entries by booking. Read-only; no withdrawals.
            </p>
          </CardHeader>
          <CardContent>
