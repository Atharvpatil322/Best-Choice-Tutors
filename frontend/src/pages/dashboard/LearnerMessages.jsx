        ...
        <CardContent>
          {bookings.length === 0 ? (
            <p className="text-muted-foreground py-6">
              No chat yet. Book a session and pay to unlock chat with your tutor. You can also open
              chat from <strong>My Bookings</strong> for any paid or completed booking.
            </p>
          ) : (
