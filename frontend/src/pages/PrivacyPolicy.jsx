/**
 * Privacy Policy - Public page with the actual platform policy for learners and tutors
 */
    ...
    <div className="min-h-screen w-full overflow-x-hidden flex flex-col">
      ...
      <main className="flex-1 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto space-y-8">
          <div>
            <h1 className="text-3xl sm:text-4xl font-bold text-[#1A365D]">Privacy & Platform Policy</h1>
