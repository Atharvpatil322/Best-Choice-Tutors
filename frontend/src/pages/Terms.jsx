      ...
      <main className="flex-1 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto space-y-6 text-slate-700">
          ...
          <section>
            ...
            <p className="mb-3">
              You must be at least <strong>13 years of age</strong> to register for a learner account, or have the consent of a parent or legal guardian if under 13. You must provide accurate and complete information when signing up.
            </p>
            <p>
